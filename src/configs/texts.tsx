    ...
    [PageSection.Experience]: {
      ...
      introduction: [
        ...
        <>
          ...
          , I revamped outdated code from Backbone to React, improving user experience and application performance.
          I've also worked as a tech lead at
        ...
        'I hold a Master\'s degree in Computer Science from the National Technical University of Ukraine. Proficient in English, I\'m a fast learner, team player, and always eager to explore new technologies.',
      ],
    },
