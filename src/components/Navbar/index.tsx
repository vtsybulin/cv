...
import { makeAnchorHref, makeDownloadCVLink } from '^/utils/routing';
...
const links: INavbarLink[] = [
  ...
  {
    label: texts.navbar.cvLinkLabel,
    href: makeDownloadCVLink(),
    isExternal: true,
  },
  {
    label: texts.navbar.githubLinkLabel,
    href: GITHUB_PROFILE_URL,
    color: 'primary',
    variant: 'flat',
    startContent: <RxGithubLogo className="size-5 shrink-0" />,
    isExternal: true,
  },
];
...
const Navbar = (): ReactElement => {
  ...
  return (
    ...
    >
      ...
      <NavbarContent
        className="hidden w-full gap-4 md:flex"
        justify="end"
      >
        <NavbarItem className="mr-auto">
          <ThemeDropdown />
